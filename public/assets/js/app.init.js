...
const config = {
    "language": {
        ...
        "lengthMenu": "_MENU_",
        "processing": '<span class="spinner-border spinner-border-sm text-muted align-middle me-2"></span> <span class="text-gray-600">Loading...</span>',
        "paginate": {
            "first": '<i class="fas fa-chevron-left"></i>',
            "last": '<i class="fas fa-chevron-left"></i>',
